/**
 * Where OpenBook stops being OpenCook.
 *
 ...
 * re-created. Everything after 2023 is OpenBook's own timeline.
 *
...
/** True for posts inherited from OpenCook rather than written on OpenBook. */
